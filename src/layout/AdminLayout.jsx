  ...
  return (
    <div className="flex min-h-screen w-full overflow-x-hidden bg-slate-50 font-sans">
      ...
      <div className="flex min-h-screen flex-1 flex-col overflow-hidden w-full">
            ...
            <header className="flex h-16 sm:h-18 lg:h-20 w-full shrink-0 items-center justify-between border-b border-slate-200/80 bg-white px-3 sm:px-6 lg:px-8 shadow-sm">
          <div className="flex min-w-0 items-center gap-2.5 sm:gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-xs sm:text-sm font-semibold text-slate-700 sm:text-base">
